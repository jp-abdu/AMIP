            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    FormNavigationButtonsRows(
                        ...
                        canProceed: estado.q9_pessoasSabemLerEscrever != "Selecione" &&
                                    !estado.q9_frequentaEscolaCreche.isEmpty &&
                                    !estado.q9_cursoQueFrequenta.isEmpty &&
                                    !estado.q9_concluiuOutroSuperior.isEmpty,
                        onNext: {
